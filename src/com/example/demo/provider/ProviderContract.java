...
public final class ProviderContract {
	...
	static final String TEMPORARY_PERMISSION_TABLE = "temporary_permission";
	...
	public static final String TEMPORARY_PERMISSION_AUTHORITY = "com.example.demo.provider.temporaryPermissionProvider";
	
	public static final Uri TEMPORARY_PERMISSION_URI = new Uri.Builder().scheme("content").authority(TEMPORARY_PERMISSION_AUTHORITY).path(TEMPORARY_PERMISSION_TABLE).build();
